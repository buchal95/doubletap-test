...
const CTAButton: React.FC<CTAButtonProps> = ({ 
  ...
  const baseClasses = "py-3 px-8 rounded-lg font-montserrat font-semibold text-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
