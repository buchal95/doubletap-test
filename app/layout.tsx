...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        {/* ✅ NEW: Helper script for Usercentrics integration */}
        <script
          dangerouslySetInnerHTML={{
            __html: `
              // Make consent update functions globally available
              window.updateGoogleConsent = function(settings) {
                if (window.gtag) {
                  window.gtag('consent', 'update', settings);
                }
              };
              
              // Example: Call this from Usercentrics when user accepts all
              ...
              // Example: Call this from Usercentrics when user rejects all
              ...
              // Example: Call this from Usercentrics for partial consent
              window.updatePartialConsent = function(consents) {
                var settings = {
                ...
                if (consents.marketing) {
                  ...
                  settings.non_personalized_ads = false;
                } else {
                  settings.ad_storage = 'denied';
                  settings.ad_user_data = 'denied';
                  settings.ad_personalization = 'denied';
                  settings.non_personalized_ads = true;
                }
                ...
                if (consents.functional) {
                  ...
                  settings.functionality_storage = 'denied';
                  settings.personalization_storage = 'denied';
                }
                
                window.updateGoogleConsent(settings);
              };
            `
          }}
        />
